...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${BASE}/guides/freelance-barista-france`,
      lastModified,
      changeFrequency: "monthly" as const,
      priority: 0.7,
      alternates: bilingual("/guides/freelance-barista-france"),
    },
    {
      url: `${BASE}/fr/guides/freelance-barista-france`,
      lastModified,
      changeFrequency: "monthly" as const,
      priority: 0.7,
      alternates: bilingual("/guides/freelance-barista-france"),
